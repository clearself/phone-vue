...
export const delTemplate = (data) => {
    return axios.delete('alarm//manage/hgTemplate/deleteHgTemplate', {
        params: data
    }).then(result => {
...
export const delItem = (data) => {
    return axios.delete('alarm//manage/hgTemplate/deleteHgItem', {
        params: data
    }).then(result => {
        console.log('result', result)
        return getAjax(result)
...
export const allSysRoles = (data) => {
    return axios.get('alarm/manage/operSafeReport/allSysRoles', {
        params: data
    }).then(result => {
        console.log('result', result)
        return getAjax(result)
...
export const allAutoRoles = (data) => {
    return axios.get('alarm/manage/autoSafeReport/allSysRoles', {
        params: data
    }).then(result => {
        console.log('result', result)
        return getAjax(result)
...
export const allSysRolesCommand = (data) => {
    return axios.get('alarm/manage/operSafeReportCommander/allSysRoles', {
        params: data
    }).then(result => {
        console.log('result', result)
        return getAjax(result)
...
export const allAutoRoles_auto = (data) => {
    return axios.get('alarm/manage/autoSafeReportCommander/allSysRoles', {
        params: data
    }).then(result => {
        console.log('result', result)
        return getAjax(result)
...
export const save_header_list = (data) => {
    return axios.request({
        url: 'alarm/terminal/updateHeader',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    }).then(result => {
...
export const changeAlarmState = (data) => {
    return axios.request({
        url: 'alarm/manage/common/changeStatus',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    }).then(result => {
...
export const getAlarmTemp = (data) => {
    return axios.request({
        url: 'alarm/manage/common/getWorkMould',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    }).then(result => {
...
export const add_workTask = (data) => {
    return axios.request({
        url: 'alarm/manage/common/createOrder',
        method: 'post',
        params: data.queryData,
        data: data.paramsData
    }).then(result => {
